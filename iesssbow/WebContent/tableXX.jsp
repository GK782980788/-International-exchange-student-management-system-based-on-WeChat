...
<head>
    ...
    <body>
		...
		<div id="sidebar">
            <ul>
                ...
                <li  class="current"><a href="#"><img src="${ctx}/img/icons/menu/brush.png" alt="" /> 信息管理</a>
                    <ul>
                        <li class="current"><a href="${ctx}/xxtx/list">信息模板一</a></li>
        ...
        <div id="content" class="white">
            <h1><img src="${ctx}/img/icons/posts.png" alt="" />信息管理</h1>
	<div class="bloc">
    <div class="title">
        公告
    </div>
    <div class="content">
        <table>
            ...
            <tbody>
				<c:forEach items="${page.list}" var="p">
						...
						<a href="${ctx }/xxtx/edit?id_xxtx=${p.id_xxtx }" title="编辑信息"><img style="border: 1px sold #ccc; padding-left:20px;padding-right:45px;" src="${ctx }/img/icons/actions/edit.png"/></a>
						<a href="${ctx }/xxtx/delete?id_xxtx=${p.id_xxtx }" title="删除信息"><img src="${ctx }/img/icons/actions/delete.png"/></a>				
						</td>
					</tr>
				</c:forEach>
                </tbody>
        ...
        <div class="pagination">
        	<c:forEach begin="1" end="${page.totalPageNum }" var="pageNum">
				<a name="pagen"  href="${ctx }/xxtx/list?pageNum=${pageNum }" class="current">${pageNum }</a>
			</c:forEach>
        </div>
    </div>
</div>
