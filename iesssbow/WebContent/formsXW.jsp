${ctx}/<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<div id="sidebar">
   ...
   <div class="content">
		...
		<form action="${ctx }/news/edit" method="POST">
     	<div class="right">
        <div class="input">
            <label for="input4" values="${time }" name="time">时间</label>
        ...
        <div class="input">
            ...
            <input type="text" values="${biaoTi }" name="biaoTi" id="input1" />
        </div>
        <br/>
        <br/>
    ...
    <div class="input">
            ...
            <input type="checkbox" id="check1" value="${isJapanese }" name="isJapanese"/> <!-- 默认选定属性 checked="checked" -->
            <label for="check1" class="inline">日本</label> 
            <input type="checkbox" id="check2" value="${isChinese }" name="isChinese"/>
            <label for="check2" class="inline">韩国</label> 
            <input type="checkbox" id="check3" value="${isIndonesians }" name="isIndonesians"/>
            <label for="check3" class="inline">印尼</label> 
            <input type="checkbox" id="check4" value="${isBrazilians }" name="isBrazilians"/>
            <label for="check4" class="inline">巴西</label> <br/>
            <input type="hidden" id="id" value="${news.id_news}"  name="id_news"/>
    </div>
    ...
    <div class="input">
            ...
            <input type="radio" name="type" id="check1" value="公告"/> 
            <label class="inline">公告</label> 
            <input type="radio" name="type" id="check2" value="热点"/>
            <label class="inline">热点</label> 
            <input type="radio" name="type" id="check3" value="国际"/>
            <label class="inline">国际</label> 
            <input type="radio" name="type" id="check4" value="校内"/>
...
<script type="text/javascript">
    ...
    <div class="input">
            <label for="label">定向新闻(若选择此选项则直接进行定向消息推送)</label>
            <input type="checkbox" id="check1" values="${isJapanese }" name="isJapanese"/> <!-- 默认选定属性 checked="checked" -->
            <label for="check1" class="inline">日本</label> 
            <input type="checkbox" id="check2" values="${isChinese }" name="isChinese"/>
            <label for="check2" class="inline">韩国</label> 
            <input type="checkbox" id="check3" values="${isIndonesians }" name="isIndonesians"/>
            <label for="check3" class="inline">印尼</label> 
            <input type="checkbox" id="check4" values="${isBrazilians }" name="isBrazilians"/>
            <label for="check4" class="inline">巴西</label> <br/>
    </div>
