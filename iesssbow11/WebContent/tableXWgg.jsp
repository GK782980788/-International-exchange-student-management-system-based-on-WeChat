            ...
            <tbody>
				<c:forEach items="${page.list}" var="p">
					...
					<tr>
						...
						<td>${p.time}</td>
						<td style="display:block;word-break:keep-all;width:10em;">${p.neiRongURL}</td>
						<td>
						<a href="${ctx }/news/edit?id_news=${p.id_news }" title="编辑信息"><img src="${ctx }/img/icons/actions/edit.png"/></a>
						<a href="${ctx }/news/delete_gg?id_news=${p.id_news }" title="删除信息">&nbsp<img src="${ctx }/img/icons/actions/delete.png"/></a>
						</td>
					</tr>
					</c:if>
				</c:forEach>
