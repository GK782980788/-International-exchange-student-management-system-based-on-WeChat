...
<html>
    ...
    <link rel="stylesheet" href="${ctx }/css/dilan.css">
        ...
        <!-- ZUI Javascriptç»ä»¶ -->
    <script src="${ctx }/docs/js/zui.min.doc.js"></script>
...
<ul class="pgwMenu light">
	...
	<li target="_blank"><a href="${ctx }/frontindexgg.jsp">公告</a></li>
	<li target="_blank"><a id="selected" href="${ctx }/frontindexxn.jsp">校内</a></li>
